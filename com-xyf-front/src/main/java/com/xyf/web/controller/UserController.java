...
//	用户查询
	...
	public @ResponseBody AjaxResult addSubmit(String name,Boolean isMale,Long age,String phone,String team,Long weight
	,Long height,String description,String image,String password)
	{
		User user=new User();
 ...
 */
    ...
    public @ResponseBody AjaxResult addscoresubmit(Long projectId,Long adminId,Long id,HttpServletRequest request,HttpServletResponse response) 
    {
    	//检查admin
