...
<div class="pd-20">
    <form action="<%=ctxPath%>/user/list.do">
    	...
    	<div class="text-c"> 
    		...
    		<input type="text" name="param" value="${param.param }" placeholder=" 运动员的名称" style="width:250px" class="input-text" />
        ...
        <table class="table table-border table-bordered table-bg table-hover">
            <thead>
                <tr>
                    ...
                    <th>体重(KG)</th>                   
                    <th>描述</th>                                                        
                    <th>操作  <input class="btn btn-default radius" type="button" value="返回上一级页面" onclick="parent.location.reload()"  />
                    </th>
                    ...
                    <tr>
                        ...
                        <td>
                         ...
                         <!--   <button class="btn size-MINI radius" onclick="ajaxSubmit('<%=ctxPath%>/user/delete.do', 'id=${user.id}')">删除</button> --> 
                            <button class="btn size-MINI radius" onclick="ajaxSubmit('<%=ctxPath%>/projectUser/addSubmit.do', 'id=${user.id}&&projectId=${projectId}')">添加到项目中</button> 
