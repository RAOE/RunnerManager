...
<body>
<div class="pd-20">
    <form onsubmit="ajaxSubmitForm(this,true)" action="<%=ctxPath%>/user/addSubmit.do" class="form form-horizontal" method="post" name="form1"> 
        <div class="row cl">
        ...
        <div class="row cl">
            ...
            <div class="col-10">
                <input id="male" name="isMale" type="radio" value="true" checked="checked"><label for="male">男</label>&nbsp;&nbsp;&nbsp;&nbsp;
                <input id="female" name="isMale" type="radio" value="false"/><label for="female">女</label>
            </div>
        </div>
