...
<div class="wrap">
  <div class="sign-title tc" style=" -webkit-opacity: 0.3; -moz-opacity: 0.3; -khtml-opacity: 0.3;  opacity: .3; filter:alpha(opacity=30);  ">
    <h1>手机验证</h1>
    亲爱的<a href="#" class="o">wang</a>，欢迎使用<span class="o">手机验证</span>
  </div>
  ...
  <div class="Application">
    <table class="bind-wrap">
      <tr>
        ...
        <td>
          <input type="text" value="" name="" class="ipt">
          <p class="mt10"><input type="text" value="" name="" class="ipt code"><button type="button" name="" class="button btn-send">发送短信验证码</button></p>
          <p class="point mt10">(若您<span class="ff4800">60</span>秒内未收到短信，点击<button type="button" name="" class="button btn-send">再次发送</button>)</p>
          <p class="Release-submit"><button type="button" name="" value="" class="button btn-submit Appbtn" onClick="location.href='phone-bind-done.html'">下一步</button></p>
        </td>
      </tr>
