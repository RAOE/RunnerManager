...
<div class="wrap">
  ...
  <div class="Application tc">
    <p class="f18">请输入邮箱地址：<input type="text" value="" name="" class="inputmail"></p>
    <div class="Release-submit"><button type="button" name="" value="" class="button btn-submit Appbtn" onClick="location.href='forgot2.html'">下一步</button></div>
  </div>
