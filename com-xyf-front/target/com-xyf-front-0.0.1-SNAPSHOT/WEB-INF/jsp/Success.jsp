...
<div class="wrap">
  ...
  <div class="Application tc">
    <div class="suc-header o"><img src="images/rrt.png">报名成功！</div>
    <div class="suctxt">恭喜你，你是第01期报名“<b class="o">热红酒</b>”的第 <b class="o">8</b> 位申请者。<br>
 　　我们珍惜你的信任，所以杜绝一切黑幕，招募结果将由待着网、体验地共同选拔产生，并在官网公布，衷心希望特别的你能够成为待着网的下一任体验官！ </div>
    <div class="Release-submit"><button type="button" name="" value="" class="button btn-submit Appbtn">去付款</button></div>
  </div>
